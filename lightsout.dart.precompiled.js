...
LinkedHashMapKeyIterable: {"": "IterableBase;_map",
  ...
  get$iterator: function(_) {
    ...
    t1._collection$_cell = t1._map._first;
    return t1;
  },
  forEach$1: function(_, f) {
...
LinkedHashMapKeyIterator: {"": "Object;_map,_modifications,_collection$_cell,_collection$_current",
  get$current: function() {
    return this._collection$_current;
  },
  moveNext$0: function() {
...
_LinkedHashSet: {"": "_HashSetBase;_collection$_length,_strings,_nums,_rest,_first,_last,_modifications",
  get$iterator: function(_) {
    ...
    t1._collection$_cell = t1._set._first;
    return t1;
  },
  get$length: function(_) {
    return this._collection$_length;
...
LinkedHashSetIterator: {"": "Object;_set,_modifications,_collection$_cell,_collection$_current",
  get$current: function() {
    return this._collection$_current;
  },
  moveNext$0: function() {
...
Game: {"": "Object;_board,_cells,_width,_height,win",
  click$1: function(_, pos) {
    var t1, t2;
    if (this.win)
      return;
    if (pos < 0)
    ...
    if (typeof t1 !== "number")
      throw H.iae(t1);
    if (C.JSInt_methods.$mod(pos, t1) !== 0) {
      t1 = this._cells;
      t2 = pos - 1;
      if (t2 < 0 || t2 >= t1.length)
        throw H.ioore(t1, t2);
    ...
    if (typeof t1 !== "number")
      throw H.iae(t1);
    if (C.JSInt_methods.$mod(pos, t1) !== t1 - 1) {
      t1 = this._cells;
      t2 = pos + 1;
      if (t2 >= t1.length)
        throw H.ioore(t1, t2);
    ...
    t1 = this._cells;
    if (pos >= t1.length)
      throw H.ioore(t1, pos);
    t1[pos].light$0();
    this.checkWin$0();
  },
  setWinCells$0: function() {
    H.IterableMixinWorkaround_forEach(this._cells, new U.Game_setWinCells_closure());
  },
  checkWin$0: function() {
    if (H.IterableMixinWorkaround_every(this._cells, new U.Game_checkWin_closure())) {
      this.win = true;
      this.setWinCells$0();
      J.get$classes$x(document.querySelector(".lose")).toggle$1("lose");
    }
  },
  Game$2$height$width: function(height, width) {
    var t1, i, t2, j, div, pos, $arguments, t3, cell;
    this._height = 5;
    this._width = 5;
    this._board = U.Board$(this._width, this._height);
    t1 = this._cells;
    i = 0;
    while (true) {
      t2 = this._height;
      ...
      while (true) {
        ...
        if (typeof t2 !== "number")
          throw H.iae(t2);
        pos = i * t2 + j;
        t2 = J.get$onClick$x(div);
        $arguments = H.substitute(t2.$as_EventStream, H.getRuntimeTypeInfo(t2));
        t3 = $arguments == null ? null : $arguments[0];
        t2 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.Game_closure(this, pos)), t2._useCapture);
        t2.$builtinTypeInfo = [t3];
        t3 = t2._onData;
        if (t3 != null && t2._pauseCount <= 0)
          J.addEventListener$3$x(t2._target, t2._eventType, t3, t2._useCapture);
        cell = new U.Cell(null, false, null);
        cell._pos = pos;
        cell._cell = div;
        J.set$className$x(cell._cell, "cell");
        t2 = J.get$classes$x(cell._cell);
        t2.add$1(t2, "off");
        C.JSArray_methods.insert$2(t1, pos, cell);
        t2 = J.get$children$x(this._board._game);
        t2.add$1(t2, cell._cell);
        ++j;
      }
      ++i;
    }
  ...
  static: {
Game$: function(height, width) {
  var t1 = new U.Game(null, [], null, null, false);
  t1.Game$2$height$width(height, width);
  return t1;
}}

},

Game_closure: {"": "Closure;this_0,pos_1",
  call$1: function(e) {
    var t1 = this.this_0;
    t1.click$1(t1, this.pos_1);
  },
  $is_args1: true
},

Game_setWinCells_closure: {"": "Closure;",
  call$1: function(c) {
    return c.addClass$1("winner");
  },
  $is_args1: true
},

Game_checkWin_closure: {"": "Closure;",
  call$1: function(c) {
    return J.get$on$x(c);
  },
  $is_args1: true
...
Board: {"": "Object;_height,_width,_game",
  Board$2: function(width, height) {
    ...
    if (typeof t2 !== "number")
      throw t2.$mul();
    J.set$width$x(t1, "" + t2 * 101 + "px");
  },
  static: {
Board$: function(width, height) {
  var t1 = new U.Board(null, null, null);
...
Cell: {"": "Object;_cell,on>,_pos",
  light$0: function() {
    this.on = !this.on;
    J.get$classes$x(this._cell).toggle$1("off");
  },
  addClass$1: function(cls) {
    var t1 = J.get$classes$x(this._cell);
    t1.add$1(t1, cls);
  }
}},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function Game(_board, _cells, _width, _height, win) {
    this._board = _board;
    this._cells = _cells;
    this._width = _width;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function Game_closure(this_0, pos_1) {
    this.this_0 = this_0;
    this.pos_1 = pos_1;
  }
  ...
  function Game_setWinCells_closure() {
  }
  Game_setWinCells_closure.builtin$cls = "Game_setWinCells_closure";
  if (!"name" in Game_setWinCells_closure)
    Game_setWinCells_closure.name = "Game_setWinCells_closure";
  $desc = $collectedClasses.Game_setWinCells_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_setWinCells_closure.prototype = $desc;
  function Game_checkWin_closure() {
  }
  Game_checkWin_closure.builtin$cls = "Game_checkWin_closure";
  if (!"name" in Game_checkWin_closure)
    Game_checkWin_closure.name = "Game_checkWin_closure";
  $desc = $collectedClasses.Game_checkWin_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_checkWin_closure.prototype = $desc;
  function Board(_height, _width, _game) {
    this._height = _height;
    this._width = _width;
    this._game = _game;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Cell.prototype = $desc;
  Cell.prototype.get$on = function(receiver) {
    return this.on;
  };
