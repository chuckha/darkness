...
for(z=new H.a7(a,a.length,0,null);z.G();)b.call$1(z.mD)},OF:function(a,b){var z
for(z=new H.a7(a,a.length,0,null);z.G();)if(b.call$1(z.mD)!==!0)return!1
return!0},mx:function(a,b,c){var z,y,x
...
else b.K5(c,d)},TB:function(a,b){return new P.kg(a,b)},rT:function(a,b){var z=$.X3
if(z===C.NU){z.toString
...
z.pP(a)}},dR:{"":"Tp;a,b,c",
call$0:function(){return this.a.K5(this.b,this.c)}},kg:{"":"Tp;a,b",
...
return z},Ou:function(a,b){return J.de(a,b)},T9:function(a){return J.v1(a)},Py:function(a,b,c,d,e){var z=new P.k6(0,null,null,null,null)
H.VM(z,[d,e])
...
z.PD(a)
return z}}},wv:{"":"a;"}}],["dart.dom.html","dart:html",,W,{r3:function(a,b){return document.createElement(a)},VF:function(a){var z=$.X3
if(z===C.NU)return a
...
"%":"HTMLAnchorElement"},QW:{"":"qE;oc:name=,P:value=","%":"HTMLButtonElement"},OM:{"":"KV;B:length=","%":"CDATASection|CharacterData|Comment|ProcessingInstruction|Text"},oJ:{"":"BV;B:length=",
...
H.VM(z,[null])
return z},
"%":"Document|HTMLDocument|SVGDocument"},Nh:{"":"Gv;",
bu:function(a){return a.toString()},
...
$isqC:true,
$isXj:true,
"%":"HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"},tb:{"":"qE;oc:name=","%":"HTMLIFrameElement"},Mi:{"":"qE;oc:name=,P:value=",$iscv:true,"%":"HTMLInputElement"},MX:{"":"qE;oc:name=","%":"HTMLKeygenElement"},wP:{"":"qE;P:value=","%":"HTMLLIElement"},M6:{"":"qE;oc:name=","%":"HTMLMapElement"},El:{"":"qE;kc:error=","%":"HTMLAudioElement|HTMLMediaElement|HTMLVideoElement"},Ee:{"":"qE;oc:name=","%":"HTMLMetaElement"},Qb:{"":"qE;P:value=","%":"HTMLMeterElement"},Aj:{"":"w6;","%":"DragEvent|MSPointerEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|PointerEvent|WheelEvent"},KV:{"":"D0;",
...
"%":"DocumentFragment|DocumentType|Entity|Notation|ShadowRoot;Node"},BH:{"":"kE;",
gB:function(a){return a.length},
t:function(a,b){var z=a.length
if(b>>>0!==b||b>=z)throw H.b(P.TE(b,0,z))
return a[b]},
...
$isqC:true,
$isXj:true,
"%":"NodeList|RadioNodeList"},G7:{"":"qE;oc:name=","%":"HTMLObjectElement"},Ql:{"":"qE;P:value=","%":"HTMLOptionElement"},wL:{"":"qE;oc:name=,P:value=","%":"HTMLOutputElement"},HD:{"":"qE;oc:name=,P:value=","%":"HTMLParamElement"},KR:{"":"qE;P:value=","%":"HTMLProgressElement"},lp:{"":"qE;B:length=,oc:name=,P:value=","%":"HTMLSelectElement"},zD:{"":"ea;kc:error=","%":"SpeechRecognitionError"},FB:{"":"qE;oc:name=,P:value=","%":"HTMLTextAreaElement"},w6:{"":"ea;","%":"CompositionEvent|FocusEvent|KeyboardEvent|SVGZoomEvent|TextEvent|TouchEvent;UIEvent"},Oi:{"":"D0;",
bu:function(a){return a.toString()},
gVl:function(a){var z=new W.RO(a,C.T1.Ph,!1)
H.VM(z,[null])
return z},
...
$isqC:true,
$isXj:true,
"%":"MozNamedAttrMap|NamedNodeMap"},BV:{"":"Gv+id;"},id:{"":"a;",
...
$aszM:function(){return[W.cv]}},Jn:{"":"a;WK<",
t:function(a,b){var z=new W.RO(this.gWK(),b,!1)
H.VM(z,[null])
return z}},DM:{"":"Jn;WK<,vW",
t:function(a,b){var z
if($.Vp().gvc().Fb.x4(J.Mz(b)))if(P.F7()===!0){z=$.Vp()
z=new W.eu(this.WK,z.t(z,b.toLowerCase()),!1)
H.VM(z,[null])
return z}z=new W.eu(this.WK,b,!1)
H.VM(z,[null])
return z},
static:{"":"fD",}},nN:{"":"Gv+lD;",$isList:true,$aszM:null,$isqC:true},ec:{"":"nN+Gm;",$aszM:null,$isList:true,$isqC:true},e7:{"":"ar;NL",
...
if(b>>>0!==b||b>=z.length)throw H.e(z,b)
return z[b]},
$aszM:function(){return[W.KV]}},yo:{"":"Gv+lD;",$isList:true,$aszM:null,$isqC:true},kE:{"":"yo+Gm;",$aszM:null,$isList:true,$isqC:true},zL:{"":"Gv+lD;",$isList:true,$aszM:null,$isqC:true},x5:{"":"zL+Gm;",$aszM:null,$isList:true,$isqC:true},D9:{"":"a;",
ox:function(a,b){var z,y
...
$is_aB:true}}],["","lightsout.dart",,U,{E2:function(){U.Wx(null,null)},fq:{"":"a;aW,AT,Qu,Ww,UG",
...
y=this.Qu
if(typeof y!=="number")throw H.s(y)
if(b<(z-1)*y){z=this.AT
y=b+y
if(y<0||y>=z.length)throw H.e(z,y)
z[y].Yj()}z=this.Qu
if(typeof z!=="number")throw H.s(z)
if(C.jn.Y(b,z)!==0){z=this.AT
y=b-1
if(y<0||y>=z.length)throw H.e(z,y)
z[y].Yj()}z=this.Qu
if(typeof z!=="number")throw H.s(z)
if(C.jn.Y(b,z)!==z-1){z=this.AT
y=b+1
if(y>=z.length)throw H.e(z,y)
z[y].Yj()}z=this.AT
...
z[b].Yj()
this.pD()},
IN:function(){H.bQ(this.AT,new U.DW())},
pD:function(){if(H.OF(this.AT,new U.GJ())){this.UG=!0
this.IN()
J.pP(document.querySelector(".lose")).lo("lose")}},
Kr:function(a,b){var z,y,x,w,v,u,t,s,r
this.Ww=5
this.Qu=5
this.aW=U.Pz(this.Qu,this.Ww)
z=this.AT
y=0
while(!0){x=this.Ww
if(typeof x!=="number")throw H.s(x)
...
u=y*x+w
x=J.Vg(v)
t=H.Y9(x.$asRO,H.oX(x))
s=t==null?null:t[0]
x=new W.xC(0,x.uv,x.Ph,W.VF(new U.li(this,u)),x.Sg)
x.$builtinTypeInfo=[s]
s=x.u7
if(s!=null&&x.VP<=0)J.qV(x.uv,x.Ph,s,x.Sg)
r=new U.fa(null,!1,null)
r.kA=u
r.dl=v
J.Pw(r.dl,"cell")
x=J.pP(r.dl)
...
x=J.OG(this.aW.Gt)
x.h(x,r.dl);++w}++y}},
static:{Wx:function(a,b){var z=new U.fq(null,[],null,null,!1)
z.Kr(a,b)
return z}}},li:{"":"Tp;a,b",
call$1:function(a){var z=this.a
z.ql(z,this.b)},
$is_aB:true},DW:{"":"Tp;",
call$1:function(a){return a.Ew("winner")},
$is_aB:true},GJ:{"":"Tp;",
call$1:function(a){return J.c8(a)},
$is_aB:true},uR:{"":"a;Ww,Qu,Gt",
uT:function(a,b){var z,y
this.Qu=a
this.Ww=b
this.Gt=document.querySelector("#game")
z=this.Gt.style
y=this.Qu
if(typeof y!=="number")throw y.U()
J.vP(z,""+y*101+"px")},
static:{Pz:function(a,b){var z=new U.uR(null,null,null)
z.uT(a,b)
return z}}},fa:{"":"a;dl,I>,kA",
Yj:function(){this.I=!this.I
J.pP(this.dl).lo("off")},
Ew:function(a){var z=J.pP(this.dl)
z.h(z,a)}}},1],])
...
if($desc instanceof Array)$desc=$desc[1]
GS.prototype=$desc
function fq(aW,AT,Qu,Ww,UG){this.aW=aW
this.AT=AT
this.Qu=Qu
this.Ww=Ww
this.UG=UG}fq.builtin$cls="fq"
if(!"name" in fq)fq.name="fq"
$desc=$collectedClasses.fq
if($desc instanceof Array)$desc=$desc[1]
fq.prototype=$desc
function li(a,b){this.a=a
this.b=b}li.builtin$cls="li"
...
if($desc instanceof Array)$desc=$desc[1]
GJ.prototype=$desc
function uR(Ww,Qu,Gt){this.Ww=Ww
this.Qu=Qu
this.Gt=Gt}uR.builtin$cls="uR"
if(!"name" in uR)uR.name="uR"
$desc=$collectedClasses.uR
if($desc instanceof Array)$desc=$desc[1]
uR.prototype=$desc
function fa(dl,I,kA){this.dl=dl
this.I=I
this.kA=kA}fa.builtin$cls="fa"
if(!"name" in fa)fa.name="fa"
$desc=$collectedClasses.fa
if($desc instanceof Array)$desc=$desc[1]
fa.prototype=$desc
fa.prototype.gI=function(receiver){return this.I}
...
if($desc instanceof Array)$desc=$desc[1]
zy.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,QW,n6,Ny,OM,QQ,MA,y4,d7,Um,oJ,DG,HA,vH,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,mK,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,MX,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,qm,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,p3,qj,nC,KR,ew,fs,bX,BL,ip,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,zD,Ul,KK,ii,EU,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,WS,r0,nK,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Y0,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,py,Ef,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,qF,MT,Rk,Eo,Pe,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,xJ,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,AS,F0,FK,Gv,kn,PE,Ue,iC,is,Q,nM,tN,Jt,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,JG,ns,wd,fc,YP,yc,I9,Bj,NO,II,fP,X1,HU,Pm,oo,OW,Tf,iY,yH,FA,Av,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,v,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,b8,VN,iK,Pf,Lj,vs,CQ,da,xw,dm,rH,ZL,mi,jb,wB,Pu,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,EV,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,kg,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,e8,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,EH,An,L9,a,mE,Rn,wv,BV,id,VG,Jn,DM,nN,ec,e7,yo,kE,zL,x5,D9,E9,I4,Fk,RO,eu,xC,Gm,W9,O7,rR,xG,Vj,As,GE,D7,Zf,GS,fq,li,DW,GJ,uR,fa,Wv,yh,Cm,vE,zy]}